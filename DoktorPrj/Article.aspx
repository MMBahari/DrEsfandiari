<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Article.aspx.cs" Inherits="DoktorPrj.Article" %>
...
<head runat="server">
    <title>Article Neurologist Project</title>
    ...
    <form id="form1" runat="server">
        <section class="_w100 _position-r _dir-align-r">
            ...
            <section class="_flex _position-a base-art-p-content">
                <section class="banner-art-p-content _w100">
                </section>
                <div class="_flex title-art-p-c _w100 _position-r">
                    <h1>مقالات مغز،اعصاب و ستون فقرات</h1>
                </div>
                <section class="_bg-w1 _w100 _flex body-art-c ch-body-art-c _dir-align-r">
                    <article class="art-b-c ch-art-b-c">
                        <a title="" href="/DetailArticle.aspx" class="_flex _dir-align-r _position-r">
                            <h2 class="_flex _w90-pad5 _fnt-fa _bg-w">
                                <i class="car-rental-ico-document-fill"></i>
                                تومور های بدخیم مغز
                            </h2>
                            <figure class="_w100 _trans">
                            ...
                            <h3 class="_w90-pad5 _flex _trans" style="border-bottom: 1px solid #DDD; margin-bottom: 12px; box-shadow: 0 1px 0 0 #FFF;">
